<?php
/**
 * Plugin Name: Starks Sprutmåleri AB Leads
 * Description: Multi-step quote form block, lead inbox in the admin, CSV export, spam protection and analytics events. Built for the Starks Sprutmåleri AB lead generation demo.
 * Version: 1.0.0
 * Requires at least: 6.6
 * Requires PHP: 7.4
 * Author: Hugo Oblak
 * License: GPL-2.0-or-later
 * Text Domain: starkssprutmaleri-leads
 *

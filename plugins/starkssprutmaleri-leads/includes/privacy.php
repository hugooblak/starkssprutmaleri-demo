...
add_filter(
	...
	function ( $exporters ) {
		$exporters['starkssprutmaleri-leads'] = array(
			'exporter_friendly_name' => __( 'Quote requests', 'starkssprutmaleri-leads' ),
			'callback'               => function ( $email ) {
				$items = array();
				foreach ( npl_leads_by_email( $email ) as $lead ) {
					$data = array( array( 'name' => __( 'Received', 'starkssprutmaleri-leads' ), 'value' => $lead->post_date ) );
					...
					$items[] = array(
						'group_id'    => 'starkssprutmaleri-leads',
						'group_label' => __( 'Quote requests', 'starkssprutmaleri-leads' ),
...
add_filter(
	...
	function ( $erasers ) {
		$erasers['starkssprutmaleri-leads'] = array(
			'eraser_friendly_name' => __( 'Quote requests', 'starkssprutmaleri-leads' ),
			'callback'             => function ( $email ) {
				$removed = false;
				foreach ( npl_leads_by_email( $email ) as $lead ) {

<?php
/**
 * Demo site setup for Starks Sprutmåleri AB.
 *
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'Starks Sprutmåleri AB' );
...
$home = nps_page(
	...
	nps_pattern( 'starkssprutmaleri/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'starkssprutmaleri/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'starkssprutmaleri/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'starkssprutmaleri/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'starkssprutmaleri/thank-you' ),
...
<p class="has-large-font-size">Starks Sprutmåleri AB är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om Starks Sprutmåleri AB', $about_content . "\n\n" . nps_pattern( 'starkssprutmaleri/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'starkssprutmaleri/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder Starks Sprutmåleri AB uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'Starks Sprutmåleri AB demo ready.' );

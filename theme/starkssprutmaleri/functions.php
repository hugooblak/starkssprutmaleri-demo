<?php
/**
 * Starks Sprutmåleri AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Starks Sprutmåleri AB Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through st_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'starkssprutmaleri', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'starkssprutmaleri' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'starkssprutmaleri' ) ) );

		register_block_pattern_category( 'starkssprutmaleri-sections', array( 'label' => __( 'Starks Sprutmåleri AB sections', 'starkssprutmaleri' ) ) );
		register_block_pattern_category( 'starkssprutmaleri-pages', array( 'label' => __( 'Starks Sprutmåleri AB page layouts', 'starkssprutmaleri' ) ) );
	}
);

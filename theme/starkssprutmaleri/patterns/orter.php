...
$orter = (array) st_lead( 'orter', array() );
// One or two towns make a thin, sad-looking row - skip the section entirely.
if ( count( $orter ) < 3 ) { return; }
?>
<!-- wp:group {"align":"full","className":"st-sec-orter","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}},"backgroundColor":"ink","layout":{"type":"constrained","contentSize":"1180px"}} -->
<div class="wp-block-group alignfull st-sec-orter has-ink-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:columns {"align":"wide","verticalAlignment":"top"} -->
...
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:66%"><!-- wp:group {"className":"st-orter","layout":{"type":"flex","flexWrap":"wrap"}} -->
<div class="wp-block-group st-orter"><?php
foreach ( $orter as $o ) :
	$slug = strtolower( str_replace( array( ' ', 'å', 'ä', 'ö' ), array( '-', 'a', 'a', 'o' ), $o ) );
	?><!-- wp:paragraph {"className":"st-ort"} -->
<p class="st-ort"><a href="<?php echo $url( '/taklaggare-i-' . $slug ); ?>">Takläggare i <?php echo esc_html( $o ); ?></a></p>
<!-- /wp:paragraph -->

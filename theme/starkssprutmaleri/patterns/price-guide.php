...
/**
 * Title: ROT-avdrag
 * Slug: starkssprutmaleri/price-guide
...
?>
<!-- wp:group {"align":"full","className":"st-sec-rot","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}},"backgroundColor":"sand","layout":{"type":"constrained","contentSize":"1180px"}} -->
<div class="wp-block-group alignfull st-sec-rot has-sand-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:columns {"align":"wide","verticalAlignment":"top","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|70"}}}} -->
...
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:54%"><!-- wp:group {"className":"is-style-card st-rot-calc","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group is-style-card st-rot-calc" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><!-- wp:paragraph {"className":"is-style-eyebrow"} -->
...
$rows = array(
	...
	array( 'ROT-avdrag, 30 % av arbetet', '−36 000 kr', 'st-rot-minus' ),
	array( 'Du betalar', '176 000 kr', 'st-rot-total' ),
);
foreach ( $rows as $r ) :
	?><!-- wp:group {"className":"st-rot-row <?php echo esc_attr( $r[2] ); ?>","layout":{"type":"flex","justifyContent":"space-between","flexWrap":"nowrap"}} -->
<div class="wp-block-group st-rot-row <?php echo esc_attr( $r[2] ); ?>"><!-- wp:paragraph -->
...
<p class="has-ink-soft-color has-text-color has-small-font-size"><span class="st-sample">Exempelsiffror</span> — ditt tak kostar det ditt tak kostar. Vi kommer ut, mäter och skickar ett fast pris innan något bokas.</p>
<!-- /wp:paragraph -->

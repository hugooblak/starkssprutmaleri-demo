...
/**
 * Title: Part: sidfot
 * Slug: starkssprutmaleri/part-footer
 * Inserter: no
 *
 * Markup ligger i en pattern så att länkarna använder sajtens egen adress.
 */
$url = function ( $p ) { return esc_url( home_url( $p ) ); };
$orter = array_slice( (array) st_lead( 'orter', array() ), 0, 8 );
?>
<!-- wp:group {"tagName":"div","className":"st-footer is-style-section-dark","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|40"}}},"layout":{"type":"constrained","contentSize":"1180px"}} -->
<div class="wp-block-group st-footer is-style-section-dark" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:columns {"align":"wide","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|50"}}}} -->
<div class="wp-block-columns alignwide"><!-- wp:column {"width":"32%"} -->
<div class="wp-block-column" style="flex-basis:32%"><!-- wp:group {"className":"st-brand","layout":{"type":"flex"}} -->
...
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><a href="tel:<?php echo esc_attr( st_lead( 'telefon_tel' ) ); ?>"><strong><?php echo esc_html( st_lead( 'telefon' ) ); ?></strong></a><br><?php echo esc_html( st_lead( 'adress' ) ); ?><br>Vard. 07–18, helger efter överenskommelse<br>Org.nr 556000-0000 <span class="st-sample">(platshållare)</span></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"align":"center","fontSize":"small","className":"st-footer-note","style":{"spacing":{"margin":{"top":"var:preset|spacing|50"}}}} -->
<p class="has-text-align-center st-footer-note has-small-font-size" style="margin-top:var(--wp--preset--spacing--50)">Starks Sprutmåleri AB AB · Demosajt byggd som förslag. Bilder och omdömen är platshållare.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

 ...
 * Slug: starkssprutmaleri/how-it-works
...
?>
<!-- wp:group {"align":"full","className":"st-sec-steps","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}},"layout":{"type":"constrained","contentSize":"1180px"}} -->
<div class="wp-block-group alignfull st-sec-steps" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:heading {"align":"wide","fontSize":"xx-large"} -->
<h2 class="wp-block-heading alignwide has-xx-large-font-size">Så går det till</h2>
<!-- /wp:heading -->

<!-- wp:group {"align":"wide","className":"st-steps","style":{"spacing":{"margin":{"top":"var:preset|spacing|50"},"blockGap":"var:preset|spacing|40"}},"layout":{"type":"grid","minimumColumnWidth":"14rem"}} -->
<div class="wp-block-group alignwide st-steps" style="margin-top:var(--wp--preset--spacing--50)"><?php
$n = 0;
foreach ( $steps as $s ) :
	$n++;
	?><!-- wp:group {"className":"st-step","layout":{"type":"default"}} -->
<div class="wp-block-group st-step"><!-- wp:paragraph {"className":"st-step-n"} -->
<p class="st-step-n"><?php echo esc_html( (string) $n ); ?></p>
<!-- /wp:paragraph -->

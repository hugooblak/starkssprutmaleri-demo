 ...
 * Slug: starkssprutmaleri/storm-steps
...
<div class="wp-block-group alignfull st-sec-steps" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:heading {"align":"wide"} -->
...
<div class="wp-block-group"><!-- wp:paragraph {"className":"st-step-num"} -->
<p class="st-step-num"><?php echo (int) $i + 1; ?></p>
<!-- /wp:paragraph -->

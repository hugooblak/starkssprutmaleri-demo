...
?>
<!-- wp:group {"align":"full","className":"st-sec-faq","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}},"layout":{"type":"constrained","contentSize":"1180px"}} -->
<div class="wp-block-group alignfull st-sec-faq" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:columns {"align":"wide","verticalAlignment":"top","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|70"}}}} -->
...
<p class="has-ink-soft-color has-text-color">Hittar du inte svaret? Ring oss på <a href="tel:<?php echo esc_attr( st_lead( 'telefon_tel' ) ); ?>"><?php echo esc_html( st_lead( 'telefon' ) ); ?></a>.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
foreach ( $faqs as $f ) :
	?><!-- wp:details {"className":"st-faq-item"} -->
<details class="wp-block-details st-faq-item"><summary><?php echo esc_html( $f[0] ); ?></summary><!-- wp:paragraph {"textColor":"ink-soft"} -->
